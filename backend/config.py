...
DATABASE_NAME = os.getenv("DATABASE_NAME", "trueroute_primary")
COLLECTION_NAME = os.getenv("COLLECTION_NAME", "flights_raw")

OPEN_METEO_URL = "https://api.open-meteo.com/v1/forecast"

if not MONGODB_URI:
    raise RuntimeError(
        "MONGODB_URI is not set. Create a backend/.env file with your "
        "MongoDB connection string. See backend/.env.example for the template."
    )